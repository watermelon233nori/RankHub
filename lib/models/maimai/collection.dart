...
class CollectionRequired {
  ...
  /// 要求的曲目列表
  late List<CollectionRequiredSong> songs;
  ...
  factory CollectionRequired.fromJson(Map<String, dynamic> json) {
    return CollectionRequired(
      ...
      songs:
          (json['songs'] as List?)
              ?.map((e) => CollectionRequiredSong.fromJson(e))
              .toList() ??
          [],
      completed: json['completed'] as bool? ?? false,
    );
...
class MaimaiCollection {
  ...
  /// 收藏品要求
  late List<CollectionRequired> required;
    ...
    return MaimaiCollection(
      ...
      required:
          (json['required'] as List?)
              ?.map((e) => CollectionRequired.fromJson(e))
              .toList() ??
          [],
    );
  }
...
class CollectionGenre {
  ...
  factory CollectionGenre.fromJson(Map<String, dynamic> json) {
