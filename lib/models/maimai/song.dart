...
class SongDifficulty {
  ...
  factory SongDifficulty.fromJson(Map<String, dynamic> json) {
...
class SongDifficultyUtage {
  ...
  factory SongDifficultyUtage.fromJson(Map<String, dynamic> json) {
    ...
    return SongDifficultyUtage(
      ...
      buddyNotes: isBuddy && json['notes'] != null
          ? BuddyNotes.fromJson(json['notes'])
          : null,
    );
  }
...
class SongDifficulties {
  ...
  factory SongDifficulties.fromJson(Map<String, dynamic> json) {
    return SongDifficulties(
      standard:
          (json['standard'] as List?)
              ?.map((e) => SongDifficulty.fromJson(e))
              .toList() ??
          [],
      dx:
          (json['dx'] as List?)
      ...
      utage:
          (json['utage'] as List?)
              ?.map((e) => SongDifficultyUtage.fromJson(e))
              .toList() ??
          [],
    );
  }
...
class Song {
  Song({
    ...
    this.locked = false,
    this.disabled = false,
    this.difficulties = const SongDifficulties(),
  });
  ...
  /// 谱面难度
  late SongDifficulties difficulties;
  ...
  factory Song.fromJson(Map<String, dynamic> json) {
    return Song(
      ...
      difficulties: json['difficulties'] != null
          ? SongDifficulties.fromJson(json['difficulties'])
          : const SongDifficulties(),
    );
  }
