...
const MaimaiCollectionSchema = CollectionSchema(
  ...
  links: {},
  embeddedSchemas: {
    r'CollectionRequired': CollectionRequiredSchema,
    r'CollectionRequiredSong': CollectionRequiredSongSchema,
  },
...
int _maimaiCollectionEstimateSize(
  ...
  {
    final offsets = allOffsets[CollectionRequired]!;
    for (var i = 0; i < object.required.length; i++) {
      final value = object.required[i];
      bytesCount += CollectionRequiredSchema.estimateSize(
        value,
        offsets,
        allOffsets,
      );
...
void _maimaiCollectionSerialize(
  ...
  writer.writeObjectList<CollectionRequired>(
    offsets[6],
    allOffsets,
    CollectionRequiredSchema.serialize,
    object.required,
  );
...
MaimaiCollection _maimaiCollectionDeserialize(
  ...
  final object = MaimaiCollection(
    ...
    required:
        reader.readObjectList<CollectionRequired>(
          offsets[6],
          CollectionRequiredSchema.deserialize,
          allOffsets,
          CollectionRequired(),
        ) ??
        const [],
...
P _maimaiCollectionDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (reader.readStringOrNull(offset) ?? '') as P;
    case 6:
      return (reader.readObjectList<CollectionRequired>(
                offset,
                CollectionRequiredSchema.deserialize,
                allOffsets,
                CollectionRequired(),
...
extension MaimaiCollectionQueryObject
    on QueryBuilder<MaimaiCollection, MaimaiCollection, QFilterCondition> {
  QueryBuilder<MaimaiCollection, MaimaiCollection, QAfterFilterCondition>
  requiredElement(FilterQuery<CollectionRequired> q) {
    return QueryBuilder.apply(this, (query) {
...
extension MaimaiCollectionQueryProperty
  ...
  QueryBuilder<MaimaiCollection, List<CollectionRequired>, QQueryOperations>
  requiredProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension GetCollectionGenreCollection on Isar {
  IsarCollection<CollectionGenre> get collectionGenres => this.collection();
}

const CollectionGenreSchema = CollectionSchema(
  name: r'CollectionGenre',
  id: 8073994561360402952,
  properties: {
  ...
  estimateSize: _collectionGenreEstimateSize,
  serialize: _collectionGenreSerialize,
  deserialize: _collectionGenreDeserialize,
  deserializeProp: _collectionGenreDeserializeProp,
  idName: r'id',
  indexes: {
  ...
  getId: _collectionGenreGetId,
  getLinks: _collectionGenreGetLinks,
  attach: _collectionGenreAttach,
  version: '3.3.0',
);

int _collectionGenreEstimateSize(
  CollectionGenre object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _collectionGenreSerialize(
  CollectionGenre object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
CollectionGenre _collectionGenreDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = CollectionGenre(
...
P _collectionGenreDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _collectionGenreGetId(CollectionGenre object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _collectionGenreGetLinks(CollectionGenre object) {
  return [];
}

void _collectionGenreAttach(
  IsarCollection<dynamic> col,
  Id id,
  CollectionGenre object,
) {
...
extension CollectionGenreQueryWhereSort
    on QueryBuilder<CollectionGenre, CollectionGenre, QWhere> {
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterWhere> anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
  }

  QueryBuilder<CollectionGenre, CollectionGenre, QAfterWhere> anyGenreId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension CollectionGenreQueryWhere
    on QueryBuilder<CollectionGenre, CollectionGenre, QWhereClause> {
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterWhereClause> idEqualTo(
    Id id,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IdWhereClause.between(lower: id, upper: id));
  ...
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterWhereClause>
  idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CollectionGenreQueryFilter
    on QueryBuilder<CollectionGenre, CollectionGenre, QFilterCondition> {
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterFilterCondition>
  genreEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
...
extension CollectionGenreQueryObject
    on QueryBuilder<CollectionGenre, CollectionGenre, QFilterCondition> {}

extension CollectionGenreQueryLinks
    on QueryBuilder<CollectionGenre, CollectionGenre, QFilterCondition> {}

extension CollectionGenreQuerySortBy
    on QueryBuilder<CollectionGenre, CollectionGenre, QSortBy> {
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterSortBy> sortByGenre() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'genre', Sort.asc);
    });
  }

  QueryBuilder<CollectionGenre, CollectionGenre, QAfterSortBy>
  sortByGenreDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'genre', Sort.desc);
    });
  ...
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterSortBy> sortByGenreId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
...
extension CollectionGenreQuerySortThenBy
    on QueryBuilder<CollectionGenre, CollectionGenre, QSortThenBy> {
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterSortBy> thenByGenre() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'genre', Sort.asc);
    });
  }
  ...
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterSortBy> thenByGenreId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'genreId', Sort.asc);
    });
  }
  ...
  QueryBuilder<CollectionGenre, CollectionGenre, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<CollectionGenre, CollectionGenre, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.desc);
    });
  }

  QueryBuilder<CollectionGenre, CollectionGenre, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }
...
extension CollectionGenreQueryWhereDistinct
    on QueryBuilder<CollectionGenre, CollectionGenre, QDistinct> {
  QueryBuilder<CollectionGenre, CollectionGenre, QDistinct> distinctByGenre({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'genre', caseSensitive: caseSensitive);
  ...
  QueryBuilder<CollectionGenre, CollectionGenre, QDistinct>
  distinctByGenreId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CollectionGenre, CollectionGenre, QDistinct> distinctByTitle({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension CollectionGenreQueryProperty
    on QueryBuilder<CollectionGenre, CollectionGenre, QQueryProperty> {
  QueryBuilder<CollectionGenre, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<CollectionGenre, String, QQueryOperations> genreProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'genre');
    });
  }

  QueryBuilder<CollectionGenre, int, QQueryOperations> genreIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'genreId');
    });
  }

  QueryBuilder<CollectionGenre, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
...
const CollectionRequiredSongSchema = Schema(
  name: r'CollectionRequiredSong',
  id: 6146847337859555239,
  properties: {
    ...
    r'completedDifficulties': PropertySchema(
      ...
      enumMap: _CollectionRequiredSongcompletedDifficultiesEnumValueMap,
    ),
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.string,
      enumMap: _CollectionRequiredSongtypeEnumValueMap,
    ),
  },

  estimateSize: _collectionRequiredSongEstimateSize,
  serialize: _collectionRequiredSongSerialize,
  deserialize: _collectionRequiredSongDeserialize,
  deserializeProp: _collectionRequiredSongDeserializeProp,
);

int _collectionRequiredSongEstimateSize(
  CollectionRequiredSong object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _collectionRequiredSongSerialize(
  CollectionRequiredSong object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
CollectionRequiredSong _collectionRequiredSongDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = CollectionRequiredSong(
    ...
    completedDifficulties:
        reader
            ...
            ?.map(
              (e) =>
                  _CollectionRequiredSongcompletedDifficultiesValueEnumMap[e] ??
                  LevelIndex.basic,
            )
            .toList() ??
        const [],
    ...
    type:
        _CollectionRequiredSongtypeValueEnumMap[reader.readStringOrNull(
          offsets[4],
        )] ??
        SongType.standard,
  );
...
P _collectionRequiredSongDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
  ...
  switch (propertyId) {
    ...
    case 3:
      return (reader.readStringOrNull(offset) ?? '') as P;
    case 4:
      return (_CollectionRequiredSongtypeValueEnumMap[reader.readStringOrNull(
                offset,
              )] ??
              SongType.standard)
          as P;
...
const _CollectionRequiredSongcompletedDifficultiesEnumValueMap = {
  r'basic': r'basic',
...
const _CollectionRequiredSongcompletedDifficultiesValueEnumMap = {
...
const _CollectionRequiredSongtypeEnumValueMap = {
  r'standard': r'standard',
  r'dx': r'dx',
  r'utage': r'utage',
};
const _CollectionRequiredSongtypeValueEnumMap = {
  r'standard': SongType.standard,
  r'dx': SongType.dx,
  r'utage': SongType.utage,
};

extension CollectionRequiredSongQueryFilter
    on
        QueryBuilder<
...
extension CollectionRequiredSongQueryObject
    on
        QueryBuilder<
          CollectionRequiredSong,
          CollectionRequiredSong,
...
const CollectionRequiredSchema = Schema(
  name: r'CollectionRequired',
  id: 6165725745377139385,
  properties: {
    r'completed': PropertySchema(
      id: 0,
      name: r'completed',
    ...
    r'difficulties': PropertySchema(
      ...
      name: r'difficulties',
      type: IsarType.stringList,
      enumMap: _CollectionRequireddifficultiesEnumValueMap,
    ),
    r'fc': PropertySchema(
      id: 2,
      name: r'fc',
      type: IsarType.string,
      enumMap: _CollectionRequiredfcEnumValueMap,
    ),
    r'fs': PropertySchema(
      id: 3,
      name: r'fs',
      type: IsarType.string,
      enumMap: _CollectionRequiredfsEnumValueMap,
    ),
    r'rate': PropertySchema(
      id: 4,
      name: r'rate',
      type: IsarType.string,
      enumMap: _CollectionRequiredrateEnumValueMap,
    ),
    r'songs': PropertySchema(
      ...
      target: r'CollectionRequiredSong',
    ),
  },

  estimateSize: _collectionRequiredEstimateSize,
  serialize: _collectionRequiredSerialize,
  deserialize: _collectionRequiredDeserialize,
  deserializeProp: _collectionRequiredDeserializeProp,
);

int _collectionRequiredEstimateSize(
  CollectionRequired object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
  ...
  {
    final offsets = allOffsets[CollectionRequiredSong]!;
    for (var i = 0; i < object.songs.length; i++) {
      final value = object.songs[i];
      bytesCount += CollectionRequiredSongSchema.estimateSize(
        value,
        offsets,
        allOffsets,
      );
...
void _collectionRequiredSerialize(
  CollectionRequired object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  writer.writeObjectList<CollectionRequiredSong>(
    offsets[5],
    allOffsets,
    CollectionRequiredSongSchema.serialize,
    object.songs,
  );
}

CollectionRequired _collectionRequiredDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = CollectionRequired(
    completed: reader.readBoolOrNull(offsets[0]) ?? false,
    difficulties:
        reader
            .readStringList(offsets[1])
            ?.map(
              (e) =>
                  _CollectionRequireddifficultiesValueEnumMap[e] ??
                  LevelIndex.basic,
            )
            .toList() ??
        const [],
    fc: _CollectionRequiredfcValueEnumMap[reader.readStringOrNull(offsets[2])],
    fs: _CollectionRequiredfsValueEnumMap[reader.readStringOrNull(offsets[3])],
    rate:
        _CollectionRequiredrateValueEnumMap[reader.readStringOrNull(
          offsets[4],
        )],
    songs:
        reader.readObjectList<CollectionRequiredSong>(
          offsets[5],
          CollectionRequiredSongSchema.deserialize,
          allOffsets,
          CollectionRequiredSong(),
        ) ??
        const [],
...
P _collectionRequiredDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader
          ...
          as P;
    case 2:
      return (_CollectionRequiredfcValueEnumMap[reader.readStringOrNull(
            offset,
          )])
          as P;
    case 3:
      return (_CollectionRequiredfsValueEnumMap[reader.readStringOrNull(
            offset,
          )])
          as P;
    case 4:
      return (_CollectionRequiredrateValueEnumMap[reader.readStringOrNull(
            offset,
          )])
          as P;
    case 5:
      return (reader.readObjectList<CollectionRequiredSong>(
                offset,
                CollectionRequiredSongSchema.deserialize,
                allOffsets,
                CollectionRequiredSong(),
...
const _CollectionRequireddifficultiesEnumValueMap = {
  r'basic': r'basic',
  r'advanced': r'advanced',
  r'expert': r'expert',
  r'master': r'master',
...
const _CollectionRequireddifficultiesValueEnumMap = {
  r'basic': LevelIndex.basic,
  r'advanced': LevelIndex.advanced,
  r'expert': LevelIndex.expert,
  r'master': LevelIndex.master,
...
const _CollectionRequiredfcEnumValueMap = {
  r'apPlus': r'apPlus',
  r'ap': r'ap',
  r'fcPlus': r'fcPlus',
  r'fc': r'fc',
};
const _CollectionRequiredfcValueEnumMap = {
  r'apPlus': FCType.apPlus,
  r'ap': FCType.ap,
  r'fcPlus': FCType.fcPlus,
  r'fc': FCType.fc,
};
const _CollectionRequiredfsEnumValueMap = {
  r'fsdPlus': r'fsdPlus',
  r'fsd': r'fsd',
  r'fsPlus': r'fsPlus',
  r'fs': r'fs',
...
const _CollectionRequiredfsValueEnumMap = {
...
const _CollectionRequiredrateEnumValueMap = {
  r'sssPlus': r'sssPlus',
  r'sss': r'sss',
  r'ssPlus': r'ssPlus',
  r'ss': r'ss',
...
const _CollectionRequiredrateValueEnumMap = {
...
extension CollectionRequiredQueryFilter
    on QueryBuilder<CollectionRequired, CollectionRequired, QFilterCondition> {
  QueryBuilder<CollectionRequired, CollectionRequired, QAfterFilterCondition>
  completedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'completed', value: value),
...
extension CollectionRequiredQueryObject
    on QueryBuilder<CollectionRequired, CollectionRequired, QFilterCondition> {
  QueryBuilder<CollectionRequired, CollectionRequired, QAfterFilterCondition>
  songsElement(FilterQuery<CollectionRequiredSong> q) {
    return QueryBuilder.apply(this, (query) {
