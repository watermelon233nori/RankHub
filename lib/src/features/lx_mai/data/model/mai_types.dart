enum LevelIndex {
  ...
  static LevelIndex fromLabel(String label) {
    return LevelIndex.values.firstWhere(
      (e) => e.label == label,
      orElse: () => throw ArgumentError('Invalid label for LevelIndex: $label'),
    );
  }

  static LevelIndex fromString(String value) {
    return LevelIndex.values.firstWhere(
      (e) => e.value == int.parse(value),
      orElse: () => throw ArgumentError('Invalid value for LevelIndex: $value'),
    );
  }
}
