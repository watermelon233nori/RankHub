...
class LxMaiSongDetail extends StatefulWidget {
  const LxMaiSongDetail({super.key, required this.song});

  final SongInfo song;

  @override
  State<LxMaiSongDetail> createState() => _LxMaiSongDetailState();
}

class _LxMaiSongDetailState extends State<LxMaiSongDetail>
